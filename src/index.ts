...
program
  ...
  .action(async (opts) => {
    ...
    // Use Unicode escapes to survive Windows code-page encoding
    const G = '\x1b[32m', B = '\x1b[1m\x1b[32m', R = '\x1b[0m', D = '\x1b[90m', Y = '\x1b[33m', C = '\x1b[36m';
    const u = (s: string) => s; // all chars below are \uXXXX safe
    process.stdout.write(
      ...
      `  \u255a\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u255d  \u255a\u2550\u255d\u255a\u2550\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u255d  \u255a\u2550\u255d\n` +
      `${R}\n` +
      `${D}  v${VERSION} \u00b7 OS-level Desktop Automation Server${R}\n` +
      `${D}  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500${R}\n\n` +
      `${Y}  \u26a0  DESKTOP CONTROL ACTIVE${R}\n` +
      `${D}  This server can move your mouse, type keystrokes,${R}\n` +
      `${D}  take screenshots, and interact with any app on${R}\n` +
      `${D}  your screen. Only connect AI models you trust.${R}\n` +
      `${D}  Binds to localhost only \u2014 not exposed to network.${R}\n` +
      `${D}  Run ${C}clawdcursor stop${D} when done.${R}\n\n` +
      `${D}  \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500${R}\n\n`
    );
